...
router.get("/", async (req, res) => {
  try {
    ...
    const url =
      `https://neextltda-canvas-api.hf.space/musicard/onepiece` +
    ...
    console.error("Erro musicardonepiece:", err.message);
    return res.status(500).json({ error: "Erro interno ao gerar Musicard One Piece" });
  }
});
