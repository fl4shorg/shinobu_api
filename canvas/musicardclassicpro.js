...
router.get("/", async (req, res) => {
  try {
    ...
    const url =
      `https://neextltda-canvas-api.hf.space/musicard2/classicpro` +
    ...
    console.error("Erro musicardclassicpro:", err.message);
    return res.status(500).json({ error: "Erro interno ao gerar Musicard Classic Pro" });
  }
});
