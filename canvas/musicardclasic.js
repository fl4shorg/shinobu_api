...
router.get("/", async (req, res) => {
  try {
    ...
    const url =
      `https://neextltda-canvas-api.hf.space/musicard2/classic` +
    ...
    console.error("Erro musicardclasic:", err.message);
    return res.status(500).json({ error: "Erro interno ao gerar Musicard Classic" });
  }
});
